...
/mob/camera/aiEye/remote/holo/setLoc()
	. = ..()
	var//obj/machinery/hologram/H = origin
...
/datum/holocall
	...
	var//obj/machinery/hologram/calling_holopad	//the one that sent the call
	var//obj/machinery/hologram/connected_holopad	//the one that answered the call (may be null)
...
/datum/holocall/New(mob/living/caller, /obj/machinery/hologram/calling_pad, list/callees)
	...
	for(var/I in callees)
		var//obj/machinery/hologram/H = I
...
/datum/holocall/proc/Disconnect(/obj/machinery/hologram/H)
...
/datum/holocall/proc/ConnectionFailure(/obj/machinery/hologram/H, graceful = FALSE)
...
/datum/holocall/proc/Answer(/obj/machinery/hologram/H)
	...
	for(var/I in dialed_holopads)
		if(I == H)
			continue
		var//obj/machinery/hologram/Holo = I
